...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.connection_kwargs_data'
        db.add_column('mailer_message', 'connection_kwargs_data', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.connection_kwargs_data'
        db.delete_column('mailer_message', 'connection_kwargs_data')
